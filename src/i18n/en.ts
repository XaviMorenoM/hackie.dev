...
export const en: Translations = {
  ...
  product: {
    ...
    screenshotAlts: [
      '{app} Today screen: no routine scheduled, with Just lift and Browse library buttons and the week ahead',
      '{app} Library screen with Push, Pull, Leg and Upper Body routines and their run counts',
      '{app} Progress screen with tracked lifts, sparkline trends and body weight',
      '{app} You screen with lifetime workouts, kilograms lifted, hours trained and recent sessions',
    ],
