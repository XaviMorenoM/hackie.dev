...
export const es: Translations = {
  ...
  product: {
    ...
    screenshotAlts: [
      ...
      'Pantalla Progreso de {app} con ejercicios seguidos, tendencias y peso corporal',
      'Pantalla Tú de {app} con entrenamientos totales, kilos levantados, horas entrenadas y sesiones recientes',
    ],
